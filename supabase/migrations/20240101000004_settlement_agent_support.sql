-- Settlement Agent Support Migration
...
ALTER TABLE property_owner_forms_list ENABLE ROW LEVEL SECURITY;

-- Basic RLS policies
CREATE POLICY "Allow all operations for application_types" ON application_types
    FOR ALL USING (true);

CREATE POLICY "Allow all operations for property_owner_forms_list" ON property_owner_forms_list
    FOR ALL USING (true);