  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        View,
        { style: styles.footer },
        React.createElement(Text, { style: styles.footerText }, React.createElement(Text, { style: { fontWeight: 'bold' } }, 'Goodman Management Group')),
        React.createElement(Text, { style: styles.footerText }, `This document was generated on ${generatedDate}`),
        React.createElement(Text, { style: styles.footerText }, 'For questions or concerns, please contact GMG ResaleFlow at resales@gmgva.com or (804) 360-2115')
      )
    )
  );
}
