...
const PricingSchema = {
  ...
  INFO_PACKET_BASE_PRICE: { min: 0, default: 20000 },
  INFO_PACKET_RUSH_FEE: { min: 0, default: 7066 },
};
...
export const PRICING_CONFIG = {
  ...
  INFO_PACKET_BASE_PRICE: parseEnvVar('INFO_PACKET_BASE_PRICE', PricingSchema.INFO_PACKET_BASE_PRICE),
  INFO_PACKET_RUSH_FEE: parseEnvVar('INFO_PACKET_RUSH_FEE', PricingSchema.INFO_PACKET_RUSH_FEE),
};
...
export function getPricing(applicationType, isRush = false) {
  const config = {
    ...
    info_packet: {
      base: PRICING_CONFIG.INFO_PACKET_BASE_PRICE,
      rush: PRICING_CONFIG.INFO_PACKET_RUSH_FEE
    }
  };
