...
export function initializeFormData(propertyState, applicationData, userData) {
  ...
  sections.forEach(section => {
    section.fields.forEach(field => {
      ...
      // Note: placeholder is NOT set as the value - it's only used as HTML placeholder attribute
      if (field.type === 'select') {
        ...
        // Always start with empty string - placeholder will be shown via HTML placeholder attribute
        formData[field.key] = '';
      }
