  ...
  const loadHOAProperties = async () => {
    try {
      const { data, error } = await supabase
        .from('hoa_properties')
        .select('id, name, location, is_multi_community, allow_public_offering, pos_notice, allow_info_packet, info_packet_price, info_packet_allowed_domains, force_price_enabled, force_price_value, multi_community_comment')
