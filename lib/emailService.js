    ...
    const mailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p>Your Resale Certificate for <strong>${propertyAddress}</strong> in <strong>${hoaName}</strong> is now ready and attached to this email.</p>
          <p>The following documents are included as attachments:</p>
          <ul>
            <li>📄 Virginia Resale Certificate (PDF)</li>
            <li>📂 Property supporting documents</li>
          </ul>
