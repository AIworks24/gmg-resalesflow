 ...
 * Converts DOCX/DOC files to PDF using Mammoth (DOCX to HTML) and react-pdf/renderer (HTML to PDF)
 */
...
<body>
    ...
    // Convert HTML to PDF using react-pdf/renderer
    const { htmlToPdf } = await import('./reactPdfService.js');
