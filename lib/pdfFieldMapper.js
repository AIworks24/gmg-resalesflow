...
const FIELD_TO_FORMDATA = {
  ...
  "Check Box11.": (formData) => {
    ...
    if (process.env.NODE_ENV === 'development') {
      console.log('[Check Box11.] budgetAttached:', budgetAttached, 'type:', typeof budgetAttached, 'result:', result);
      console.log('[Check Box11.] full path:', formData.disclosures?.operatingBudget);
    }
    return result;
  },
