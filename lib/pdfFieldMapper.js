...
const FIELD_TO_FORMDATA = {
  ...
  "cb4.1": (formData) => {
    const hasAssessments = formData.disclosures?.assessmentSchedule?.hasAssessments;
    const result = hasAssessments === true ? "True" : "False";
    console.log('[cb4.1] Mapping function called (Appendix 4 - Association levies assessments checkbox):');
    console.log('  - hasAssessments value:', hasAssessments);
    console.log('  - final result:', result);
    return result;
  },
  "cb4.2": (formData) => {
    const hasTransferAssessment = formData.disclosures?.assessmentSchedule?.hasTransferAssessment;
    const result = hasTransferAssessment === true ? "True" : "False";
    console.log('[cb4.2] Mapping function called (Appendix 4 - Transfer assessment checkbox):');
    console.log('  - hasTransferAssessment value:', hasTransferAssessment);
    console.log('  - final result:', result);
    return result;
  },
  ...
  "Group_Appx4.1.Choice1": (formData) => {
    const hasAssessments = formData.disclosures?.assessmentSchedule?.hasAssessments;
    const result = hasAssessments === true ? "1" : "0";
    console.log('[Group_Appx4.1.Choice1] Mapping function called (backward compatibility):');
    return result;
  },
