-- Migration: Create application_property_groups table for multi-community applications
-- This table stores individual property groups within a single multi-community application
...
DROP TRIGGER IF EXISTS update_application_property_groups_updated_at ON application_property_groups;
...
DROP POLICY IF EXISTS "Allow read access to application property groups" ON application_property_groups;
...
DROP POLICY IF EXISTS "Allow insert access to application property groups" ON application_property_groups;
...
DROP POLICY IF EXISTS "Allow update access to application property groups" ON application_property_groups;
...
DROP POLICY IF EXISTS "Allow delete access to application property groups" ON application_property_groups;
