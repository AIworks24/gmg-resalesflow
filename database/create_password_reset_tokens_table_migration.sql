...
-- This table stores password reset tokens with SHA-256 hashes (never plaintext)
-- Similar structure to email_verification_tokens for consistency
...
-- Add comment
COMMENT ON TABLE password_reset_tokens IS 'Stores password reset tokens with SHA-256 hashes. Tokens are never stored in plaintext.';
